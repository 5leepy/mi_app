...
# routes/admin.py
#
# Blueprint & view untuk halaman admin (Super Admin)
# - Dashboard admin: daftar siswa, pagination, statistik
# - Bulk delete siswa & hasil tes
# =====================================
...
def dashboard():
    ...
    # Ambil data siswa untuk halaman ini
...
def bulk_delete_siswa():
    """
    Hapus data siswa & hasil tes secara massal (bulk delete).
    ID siswa diambil dari form (checkbox di dashboard).
    """
    ...
    db = get_db()
    try:
        # Hapus hasil_tes dan siswa sekaligus
